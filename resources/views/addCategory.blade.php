...
<body class="antialiased bg-gray-100 dark:bg-gray-900">
    ...
    <main class="container mx-auto px-4 py-6">
        <h2 class="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Add Category</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 p-6">
                <form action="{{ url('addCategory') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 transition">Add Category</button>
                    </div>
                </form>
            </div>
        </div>
